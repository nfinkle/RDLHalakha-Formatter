...
@app.route('/_app_script_format')
def app_script_format():
    alt_spellings, italicized_words, suggestions = get_all_words()
    return render_template('app_script_format.html', corrected=sortDict(alt_spellings),  italicized=italicized_words, num_words=len(alt_spellings.keys()), num_suggestions=suggestions)
